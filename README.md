...
Project Description
This project analyzes YouTube Trending Videos collected from multiple countries. The dataset includes two types of files: CSV files containing video‑level information (such as views, likes, tags, and category IDs) and JSON files containing the official YouTube category definitions for each country.
